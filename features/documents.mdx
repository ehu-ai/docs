...
<AccordionGroup>
  <Accordion title="Business & Strategy Templates">
    - **Company Mission & Vision**: Define organizational purpose and direction
    - **Strategy**: Capture strategic objectives and initiatives - **Lean
    Canvas**: One-page business model overview - **Key Insights**: Document
    unique perspectives and market opportunities - **Problem Statement**:
    Articulate the problem you're solving - **Solution Proposal**: Outline
    proposed solutions and approaches
  </Accordion>
  <Accordion title="Planning & Communication Templates">
    - **Six Pager**: Amazon-style narrative document for proposals - **Investor
    Elevator Pitch**: Concise pitch for investor conversations - **Seed Investor
    One-Pager**: Quick overview for seed funding - **Seed Investor Pitch**:
    Comprehensive investor presentation - **Hypothesis**: Document assumptions
    and testing plans
  </Accordion>
  <Accordion title="Product Templates">
